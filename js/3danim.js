...
var tl = new TimelineMax();
   ...
   .to(rDoor, 1, {rotationY: -75, transformOrigin: "320 208 -10", ease: Power4.easeInOut })
   .to(rDoor, 1, {rotationY: 0, transformOrigin: "320 208 -10", ease: Power4.easeInOut, delay:1})
